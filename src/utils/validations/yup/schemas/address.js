...
const addressSchema = yup.object().shape({
    ...
    [ADDRESS_FIELDS.PHONE]: yup.string().required().min(13).max(13).label(ADDRESS_LABELS.PHONE),
    [ADDRESS_FIELDS.NUMBER]: yup.number().required().min(9).max(9).label(ADDRESS_LABELS.NUMBER),
